...
$tglTerakhir = 25;
 ...
 <table width="100%">
 	<tr>
 		<td>
 			<img src="../../../assets/img/asshofa.png" width="130">
 		</td>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSESNSI SISWA <br>
 					<small> SMK AS-SHOFA</small>
 				</h1>
 				<hr>
 				<em>
				 Pondok Pesantren As-Shofa Sindangkaramat Cilampunghilir <br>Padakembang Tasikmalaya Tlp. /Fax.( 0265 ) 549072
 				<br><b>e-mail : smkasshofa@yahoo.com Web site : www.smkasshofa.sch.id</b> 
 				</em>
...
<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
  ...
  <tr>
	...
	<td bgcolor="#9C27B0" align="center">K</td>
