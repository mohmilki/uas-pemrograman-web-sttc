<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Aplikasi SIAP</h2>
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/asshofa.png" width="100">
											<br>
											<b>SIAP (SISTEM INFORMASI ABSENSI PEMBELAJARAN) <br>SMK AS-SHOFA</b>
										</center>
									</div>
									<div class="card-category">
										<center>
Pondok Pesantren As-Shofa Sindangkaramat Cilampunghilir Padakembang
Tasikmalaya Tlp. /Fax.( 0265 ) 549072
	<br>e-mail : smkasshofa@yahoo.com Web site : www.smkasshofa.sch.id
										</center>
									</div>
