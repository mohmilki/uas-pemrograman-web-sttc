...
<head>
	...
	<title>Administrator | Aplikasi SIAP</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<!-- <img src="../assets/img/asshofa.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SIAP SMK AS-SHOFA</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMK AS-SHOFA (<a href="index.php"> </a> 2021)
					</div>				
				</div>
			</footer>
		</div>
